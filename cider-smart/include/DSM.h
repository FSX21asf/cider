...
class DSM {
   public:
    ...
    void write_batches_sync(RdmaOpRegion* rs,
                            int k,
                            CoroContext* ctx = nullptr,
                            int coro_id = 0);
    ...
    void write_cas_mask(RdmaOpRegion& write_ror,
                        RdmaOpRegion& cas_ror,
                        uint64_t equal,
                        uint64_t val,
                        ...
                        bool signal = true,
                        CoroContext* ctx = nullptr);
    void write_cas_mask_sync(RdmaOpRegion& write_ror,
                             RdmaOpRegion& cas_ror,
                             uint64_t equal,
                             uint64_t val,
                             uint64_t compare_mask,
    ...
    void two_cas_mask(RdmaOpRegion& cas_ror_1,
                      uint64_t equal_1,
                      uint64_t val_1,
                      uint64_t mask_1,
                      ...
                      bool signal = true,
                      CoroContext* ctx = nullptr);
    std::pair<bool, bool> two_cas_mask_sync(RdmaOpRegion& cas_ror_1,
                                            uint64_t equal_1,
                                            uint64_t val_1,
                                            uint64_t mask_1,
                                            RdmaOpRegion& cas_ror_2,
    ...
    bool cas_mask_sync(
        ...
        uint64_t compare_mask = ~(0ull),
        uint64_t swap_mask =
            ~(0ull),  // !!NOTE: the swap_mask must contains compare_mask
        CoroContext* ctx = nullptr);
