...
class RdmaBuffer {
   private:
    ...
    static const int kPageBufferCnt =
   ...
   public:
    ...
    void set_buffer(char* buffer) {
        ...
        leaf_buffer = (char*)((char*)page_buffer +
                              define::allocationPageSize * kPageBufferCnt);
        header_buffer =
            (uint64_t*)((char*)leaf_buffer +
                        define::allocAlignLeafSize * kLeafBufferCnt);
        entry_buffer = (uint64_t*)((char*)header_buffer +
                                   sizeof(uint64_t) * kHeaderBufferCnt);
        cas128_buffer = (uint64_t*)((char*)entry_buffer +
                                    sizeof(uint64_t) * kEntryBufferCnt);
